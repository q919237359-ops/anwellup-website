...
const floors = [
  ["plastic-blister-injection-malaysia-source.png", "Forming & moulding", "Plastic blister and injection-moulding equipment.", "Kuala Lumpur"],
  ["paper-cup-line-kunming-source.png", "Paper formats", "Paper cup, bowl and box production.", "Yunnan Kunming"],
  ["bag-production-chuzhou-source.png", "Bag conversion", "Equipment for the carry-bag range.", "Anhui Chuzhou"],
  ["coated-paper-floor-philadelphia-source.png", "Material handling", "Coated-paper reels on the production floor.", "Philadelphia"],
  ["injection-moulding-cangzhou-source.png", "Production layout", "Injection-moulding and plastic-blister production hall.", "Hebei Cangzhou"],
  ["plastic-blister-injection-sichuan-source.png", "The equipment floor", "Multiple workstations within a packaging production hall.", "Sichuan Lezhi"],
];
...
export default function ManufacturingPage() {
  return <ScrollMotion variant="manufacturing"><main id="main-content" className="atelier-page">
    ...
    <section className="atelier-overview" aria-labelledby="overview-title"><figure><img src="/assets/manufacturing/2026-09-source/aluminium-factory-overview-source.png" alt="Factory exterior from the supplied Ningbo Times aluminium foil catalogue" width={720} height={362}/><figcaption>Ningbo Times Aluminium Foil Technology Corp., Ltd. / Source catalogue photograph.</figcaption></figure><div data-reveal><h2 id="overview-title">The process<br/>behind the product.</h2><p>Forming, tooling and handling each play a part in a packaging project. Match the process to the product shape, material and intended application.</p></div></section>
