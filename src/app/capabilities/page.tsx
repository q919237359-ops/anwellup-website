...
export default function CapabilitiesPage() {
  return <main id="main-content" className="page-main capabilities-editorial">
    ...
    <section className="production-intro"><div className="production-copy"><h2>Explore the<br/>production process.</h2><p>Discover manufacturing imagery and discuss aluminium-container lines, tooling and collection equipment.</p><Link className="editorial-link" href="/manufacturing/">Manufacturing &amp; equipment <span><ArrowUpRight size={20}/></span></Link></div><figure><img src="/assets/manufacturing/2026-09-source/aluminium-factory-overview-source.webp" alt="Factory exterior from the Ningbo Times source catalogue" width={720} height={362} loading="lazy"/><figcaption>Source: Ningbo Times catalogue. Facility relationship confirmed per project.</figcaption></figure></section>
