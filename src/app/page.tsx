...
export default function HomePage() {
  return <ScrollMotion variant="home"><main id="main-content" className="editorial-home">
    ...
    <section className="production-intro" aria-labelledby="production-title">
      ...
      <figure><img src="/assets/manufacturing/2026-09-source/aluminium-factory-overview-source.png" alt="Factory exterior from the Ningbo Times aluminium packaging catalogue" width={720} height={362} loading="lazy" /><figcaption>Source: Ningbo Times catalogue. Facility relationship confirmed per project.</figcaption></figure>
    </section>
    <section className="collaboration-section" aria-labelledby="collaboration-title"><header data-reveal><h2 id="collaboration-title">From selection<br/>to specification.</h2></header><ol>{steps.map(([title, body], index) => <li data-reveal key={title}><span>{String(index + 1).padStart(2,"0")}</span><h3>{title}</h3><p>{body}</p></li>)}</ol><div className="collaboration-links"><Link href="/quality-compliance/">Quality &amp; product documents <ArrowUpRight size={17}/></Link><a href="/downloads/ANWELLUP_Product_Catalogue_2026.pdf" download>Download catalogue <ArrowDown size={17}/></a></div></section>
