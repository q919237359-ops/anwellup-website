  ...
  return <main id="main-content" className="page-main category-page">
    ...
    <section className="category-sourcing-guide" aria-labelledby="sourcing-title">
      ...
      {seo.clusterLinks && <section className="category-cluster" aria-labelledby="cluster-title">
        <header><span className="eyebrow">{category.id === "boxes" ? "Takeaway container knowledge base" : category.id === "cups" ? "Cup and drinkware knowledge base" : category.id === "cutlery" ? "Cutlery and meal-kit knowledge base" : category.id === "tableware" ? "Plates, bowls and trays knowledge base" : category.id === "foil" ? "Foil and food-wrap knowledge base" : category.id === "bags" ? "Carry and shopping-bag knowledge base" : "Buyer knowledge base"}</span><h2 id="cluster-title">Continue by purchasing decision.</h2></header>
