...
export const catalogCategories: CatalogCategory[] = [
  ...
  { id: "bags", slug: "carry-shopping-bags", label: "Carry + Shopping Bags", shortLabel: "Carry Bags", editorial: "Carry bags for retail and takeaway.", description: "PE and non-woven carry formats with print and packing options for retail programs.", image: "/assets/catalog/2026-09-r1/carry-shopping-bags-sage-composite-v2.png" },
