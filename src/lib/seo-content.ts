...
export const categorySeoContent: Record<CategoryId, CategorySeoContent> = {
  ...
  bags: {
    ...
    description: "Compare custom PE T-shirt and non-woven shopping bags for wholesale takeaway, grocery and retail programs by load, dimensions, print and packing.",
    heading: "Define the bag by what it needs to carry.",
    introduction: "A reliable shopping-bag brief starts with the packed product and carry routine. Finished width, gusset and length then connect to material or fabric specification, handle construction, print coverage, sample checks and case packing.",
    notes: [
      { label: "01", title: "Load & dimensions", body: "Share the packed product, expected load, number of items, carry distance and finished width, gusset, length and handle geometry." },
      { label: "02", title: "Material & handle", body: "Identify PE film or non-woven fabric and state the measurable construction, colour, seam, handle and attachment requirements to review." },
      { label: "03", title: "Print & presentation", body: "Include artwork versions, colours, print sides, coverage, bag colour, fold, inner pack, labels and carton marks." },
    ],
    questions: [
      ...
      { question: "What is the MOQ for custom shopping bags?", answer: "MOQ is confirmed for the exact bag construction, dimensions, colour, artwork versions, packing, quantity unit and destination. It is not one category-wide number." },
      { question: "How should bag load be evaluated?", answer: "Provide the packed products, expected total load, shape, sharp or concentrated points and carry routine, then test the exact identified sample under those conditions." },
      { question: "Can PE and non-woven bag specifications be compared directly?", answer: "Use construction-specific measurable fields and the same packed-load routine. Do not treat film thickness and non-woven fabric weight as interchangeable specifications." },
      { question: "Which packing data is needed for shipping?", answer: "Request the fold, pieces per inner pack and carton, carton dimensions, gross weight, labels and carton marks for each confirmed bag and artwork version." },
    ],
    procurement: [
      { label: "01 / Load", title: "Packed product and carry route", body: "List every item, packed dimensions, expected total load, number of items, concentrated or sharp points, carrying distance and handling conditions." },
      { label: "02 / Geometry", title: "Finished bag and handle dimensions", body: "State finished width, side or bottom gusset, length, handle opening and position. Keep the drawing or measurement convention with the approval record." },
      { label: "03 / Construction", title: "PE film or non-woven fabric", body: "Name the preferred material, colour and measurable film or fabric specification, plus seams, edge finish, handle and attachment details to review." },
      { label: "04 / Identity", title: "Artwork and print coverage", body: "Provide artwork versions, print sides, colours, coverage, placement, barcode or label needs and the person responsible for proof approval." },
      { label: "05 / Approval", title: "Samples and loaded-bag test", body: "Define whether the sample must confirm dimensions, material, print layout, colour, construction or loaded carrying, and record the exact version tested." },
      { label: "06 / Commercial", title: "MOQ and quantity by version", body: "Separate quantities by size, construction, colour and artwork and clarify pieces, inner packs or cases. Request MOQ and price on the same basis." },
      { label: "07 / Logistics", title: "Fold and carton configuration", body: "Request the fold, inner quantity, pieces per carton, carton dimensions, gross weight, labels and carton marks for storage and loading calculations." },
    ...
    clusterLinks: [
      ...
      { label: "Food packaging MOQ guide", href: "/guides/food-packaging-moq-guide/", intent: "Commercial planning" },
      { label: "Food packaging RFQ checklist", href: "/guides/food-packaging-rfq-checklist/", intent: "Final enquiry preparation" },
      { label: "Custom takeaway containers", href: "/solutions/custom-takeaway-containers/", intent: "Coordinated takeaway packaging" },
      { label: "Restaurant-chain takeaway packaging", href: "/solutions/restaurant-chain-takeaway-packaging/", intent: "Multi-site carry program" },
    ],
  },
  gloves: {
    title: "Disposable Gloves Wholesale for Handling",
    description: "Compare nitrile, vinyl, latex, HDPE and TPE disposable gloves for wholesale handling and operational programs, subject to model-specific document review.",
    heading: "Match the glove to the task and documentation.",
    introduction: "A glove brief should begin with the exact task, contact conditions, change routine and destination requirements. Material, size, colour, measurable construction, packing and supporting documents can then be evaluated without assuming unsupported performance or compliance claims.",
    notes: [
      { label: "01", title: "Task & contact", body: "Describe the handling, cleaning or operational task, duration, change frequency and relevant contact or workplace conditions." },
      { label: "02", title: "Material & fit", body: "State the preferred nitrile, vinyl, latex, HDPE or TPE material, sizes, colour, texture and weight or thickness measurement where known." },
      { label: "03", title: "Document scope", body: "Name the destination and intended-use requirements and request records tied to the exact proposed model or material before confirming suitability." },
    ],
    questions: [
      ...
      { question: "What is the MOQ for disposable gloves?", answer: "MOQ is confirmed for the exact model, material, size assortment, colour, measurable specification, packing, label or artwork and destination. It is not one category-wide number." },
      { question: "How should glove thickness or weight be compared?", answer: "Request the measurement method, location, unit and tolerance together with dimensions and material. Do not compare one measured value with an unspecified family label." },
      { question: "Does an exam-glove name prove medical-device status?", answer: "No. A family name is not a regulatory conclusion. Confirm the exact model classification, intended use and supporting records required for the destination." },
      { question: "What should a glove sample prove?", answer: "Define fit, dimensions, donning, handling, texture, colour, packing or another operational decision, then record the exact model, conditions and outcome." },
    ],
    procurement: [
      { label: "01 / Task", title: "Handling conditions and change routine", body: "Record the task, contact conditions, expected duration, change frequency, workplace process and any user or material restrictions." },
      { label: "02 / Material", title: "Exact glove construction", body: "Select nitrile, PVC or vinyl, natural rubber latex, HDPE or TPE for review and keep the exact AW SKU with every sample and document." },
      { label: "03 / Specification", title: "Size, dimensions and measurable fields", body: "Provide size assortment, dimensions, colour, piece weight or thickness with measurement method, texture, cuff and tolerances to review." },
      { label: "04 / Evidence", title: "Intended use and document scope", body: "Name the destination requirements and assess whether available declarations or reports identify the relevant product or material, scope, issuer, test basis and validity." },
      { label: "05 / Approval", title: "Identified samples and operational checks", body: "Define what the sample must prove and record the model, lot or version, test conditions, observations, decision and unresolved actions." },
      { label: "06 / Commercial", title: "MOQ and size assortment", body: "State quantities by model, size, colour and packing and clarify pieces, boxes or cases. Request MOQ and price on that same basis." },
      { label: "07 / Logistics", title: "Box, carton and label data", body: "Request count basis, pieces per box, boxes per carton, carton dimensions, gross weight, lot identification, labels and carton marks." },
    ...
    clusterLinks: [
      ...
      { label: "Powder-free latex gloves", href: "/products/gloves-protective-supplies/latex-exam-gloves/", intent: "Natural-rubber latex program" },
      { label: "Disposable HDPE gloves", href: "/products/gloves-protective-supplies/hdpe-gloves/", intent: "High-turnover handling format" },
      { label: "Food packaging RFQ checklist", href: "/guides/food-packaging-rfq-checklist/", intent: "Specification and evidence fields" },
      { label: "Food packaging MOQ guide", href: "/guides/food-packaging-moq-guide/", intent: "Commercial planning" },
      { label: "Food packaging materials comparison", href: "/guides/food-packaging-materials-comparison/", intent: "Material decision discipline" },
    ],
  },
};
